...
if __name__ == '__main__':
    with Path('solutions.txt').open() as txt_in:  # static.nytimes.com/newsgraphics/2022/01/25/wordle-solver/assets/solutions.txt
        solutions = [s.strip() for s in txt_in]  # 2309 words

    with Path('valid.txt').open() as txt_in:  # downloaded from gist.github.com/dracos/dd0668f281e685bad51479e5acaadb93
        valid_words = [s.strip() for s in txt_in]  # 12972 words, INCLUDING solutions
